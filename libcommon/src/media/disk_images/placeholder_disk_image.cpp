...
namespace vcc::media::disk_images
{
	...
	placeholder_disk_image::status_id_type placeholder_disk_image::read_sector(
	...
	{
		return status_id_type::device_empty;
	}

	placeholder_disk_image::status_id_type placeholder_disk_image::write_sector(
		[[maybe_unused]] size_type disk_head,
		[[maybe_unused]] size_type disk_track,
		[[maybe_unused]] size_type head_id,
		[[maybe_unused]] size_type track_id,
